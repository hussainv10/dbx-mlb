...
# MAGIC - **K-Means Clustering** is a partitioning algorithm that groups n observations into k clusters in which each observation belongs to the cluster with the nearest mean, a centroid, serving as a prototype of the cluster. This allows us to segregate motion sequences into clusters of similar motions based on the swing characteristics
# MAGIC
# MAGIC #### Outcomes:
