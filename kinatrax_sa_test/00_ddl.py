...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS test_batting_motion_sequence_batting_key_frames (
# MAGIC   GamePK BIGINT,
# MAGIC   ID BIGINT,
# MAGIC   PlayID STRING,
# MAGIC   Weight BIGINT,
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS test_batting_motion_sequence_batting_master (
# MAGIC   GamePK BIGINT,
# MAGIC   ID BIGINT,
# MAGIC   PlayID STRING,
# MAGIC   Weight BIGINT,
